...
line_fringe = xt4d.Line4d([xt4d.Phase4d(Qx, Qy), xt4d.NumericalFringe(b1, b1shape, len=len, nphi=5)])
...
line_forest = xt4d.Line4d([xt4d.Phase4d(Qx, Qy), xt4d.ForestFringe(b1, Kg)])
...
frin4d = xt4d.NormalForms4d(h, 2*np.pi*Qx, 2*np.pi*Qy, Qx, Qy, nturns)
