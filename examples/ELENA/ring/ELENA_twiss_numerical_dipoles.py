...
print("Horizontal tune fieldmap with sextupole: ", tw_splines.qx)
print("Vertical tune fieldmap with sextupole: ", tw_splines.qy)
print("Horizontal chromaticity fieldmap with sextupole: ", tw_splines.dqx)
print("Vertical chromaticity fieldmap with sextupole: ", tw_splines.dqy)

# Save to not rerun it every time
save_twiss(tw_splines, "twissresults/twiss_splines")
