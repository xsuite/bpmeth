...
plt.legend()
plt.savefig("figures/ELENA_betas_designVStanh.png", dpi=500)
plt.close()
...
plt.legend() 
plt.savefig("figures/ELENA_betabeating_designVStanh.png", dpi=500)
plt.close()
...
plt.legend()
plt.savefig("figures/ELENA_dispersion_designVStanh.png", dpi=500)
plt.close()
...
plt.legend()
plt.savefig("figures/ELENA_normalizeddispersion_designVStanh.png", dpi=500)
plt.close()
...
plt.legend()
plt.savefig("figures/ELENA_dispersionbeating_designVStanh.png", dpi=500)
plt.close()
...
ax.set_ylabel('Dispersion beating')
plt.legend()
plt.savefig("figures/ELENA_normalizeddispersionbeating_designVStanh.png", dpi=500)
plt.close()
